...
import Robot2 from "../components/Robot2.jsx";
...
const Projects = () => {
    ...
    const handleNavigation =(diretion)=>{
        setSelectedIndex((prevIndex) =>{
            if(diretion === "previous"){
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
                    ...
                    <div className="flex flex-col gap-5 text-white-600 my-5">
                        <p className="text-white font-semibold animatedText">{currentProject.title}</p>
                    ...
                    <Canvas>
                        ...
                        <Center>
                            <Suspense fallback={<CanvasLoader/>}>
                                <group scale={2.5} position={[-0.1,-4,0]} rotation={[0.1,-0.1,0]}>
                                        {/*<Robot2 texture={currentProject.texture}/>*/}
