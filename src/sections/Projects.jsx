...
// Function to generate ASCII art for project names
                        ...
                        <div className="bg-black-200 rounded-lg h-full flex flex-col">
                            ...
                            <div className="flex-1 p-3 sm:p-4 overflow-auto font-mono text-sm">
                                ...
                                <div className="mb-4 sm:mb-6">
                                    ...
                                    <pre className="text-green-400 text-[8px] sm:text-xs font-bold leading-tight whitespace-pre tracking-tighter bg-black bg-opacity-50 p-2 sm:p-3 rounded border border-green-500 border-opacity-30 text-center">
                                        {asciiArt}
                                    </pre>
                                </div>
